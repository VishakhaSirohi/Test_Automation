Feature: HouseNumber Field Accepting Alphabets feature
Description: The purpose of this feature is to enter alphabets in the house number field and check for the Error message.

  Scenario Outline: User enters alphabets in the house number field	
    Given user is on SignIn Page
     ...
     Examples: 
      ...
      | testemail43@gmail.com | password1 | Customer1 | Sname1  | 2018 | 12    | 13   | Street1 | ABC          | 2345 NJ  | House Number should contain number |  
