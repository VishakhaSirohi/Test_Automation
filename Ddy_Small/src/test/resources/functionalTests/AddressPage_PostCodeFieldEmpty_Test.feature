Feature: Postcode Field Empty feature
Description: The purpose of this feature is keep the postcode Field Empty and check for the Error message.

  Scenario Outline: User keep the postcode Field Empty	
    Given user is on SignIn Page
     ...
     Examples: 
      ...
      | testemail56@gmail.com | password1 | Customer1 | Sname1  | 2018 | 12    | 13   | Street1 | 234        |   | Postcode is a required field |  
